          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm animate-fade-in">
            <div className="text-center mb-6">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <FiTrash2 className="w-6 h-6 text-blue-600" />
              </div>
          ...
          <div className="bg-white rounded-[2rem] p-8 w-full max-w-sm animate-fade-in shadow-2xl border border-gray-100">
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-6">
                <FiTrash2 className="w-10 h-10 text-blue-500" />
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-4 bg-blue-500 text-white rounded-2xl font-bold text-xs hover:bg-blue-600 shadow-lg shadow-blue-200 transition-all"
                >
                  Ha, o'chirilsin
                </button>
              </div>
