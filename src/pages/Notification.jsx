...
import { FiArrowLeft, FiAlertCircle, FiLoader, FiPackage, FiBell, FiClock, FiUser, FiCalendar } from 'react-icons/fi';
      ...
      <div className="bg-gradient-to-br from-[#1447E6] to-[#0F3CC7] px-5 md:px-8 pt-10 pb-10 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <div>
            ...
            <p className="text-blue-200 text-xs mt-0.5">{totalCount} ta ogohlantirish</p>
          </div>
          ...
          <>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-50">
                  <div className="w-7 h-7 bg-red-50 rounded-xl flex items-center justify-center">
                    <FiClock className="text-red-500 w-3.5 h-3.5" />
                  </div>
                  <h2 className="text-sm font-bold text-gray-800">Muddati o'tgan qarzlar</h2>
                ...
                {overdueSales.map((sale, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 cursor-pointer hover:bg-gray-50 active:bg-gray-100 transition-colors ${index < overdueSales.length - 1 ? 'border-b border-gray-50' : ''}`}
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-1">
                            <h3 className="font-bold text-sm text-gray-900 truncate">{sale.customer_name}</h3>
                          ...
                          <div className="grid grid-cols-2 gap-x-4 gap-y-1 mt-1.5">
                            ...
                            <div className="flex items-center gap-1.5">
                              <FiClock className="w-3 h-3 text-red-400 shrink-0" />
                              <span className="text-[10px] text-red-500 font-semibold">
                                Muddat: {sale.debt_due_date ? new Date(sale.debt_due_date).toLocaleDateString('uz-UZ') : '—'}
                              </span>
                            </div>
                            <div className="flex items-center gap-1.5 col-span-2">
                              <FiAlertCircle className="w-3 h-3 text-orange-400 shrink-0" />
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-50">
                  <div className="w-7 h-7 bg-orange-50 rounded-xl flex items-center justify-center">
                    <FiPackage className="text-orange-500 w-3.5 h-3.5" />
                  </div>
                  <h2 className="text-sm font-bold text-gray-800">Kam qolgan mahsulotlar</h2>
            ...
            {totalCount === 0 && (
              <div className="text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100">
                ...
                <p className="text-gray-400 text-sm">Hech qanday ogohlantirish yo'q.</p>
              </div>
            )}
          </>
        )}
